...
class Absent_by_seven_days extends CI_Controller {   
...
public function index(){
    ...
    $data['message']            =   "";
    $data['bodytitle']          =   "Absence List <small>7 Continuous Absence </small>";
    $data['breadcrumbtitle']    =   "Dashboard > 7 Continuous Absence";
    ...
    if(!empty($varsessioncheck_id) && $label=="admin" || $label=="staff"){
          ...
          if($this->session->flashdata('student_list') != "") {
            ...
            foreach ($this->session->flashdata('student_list') as $l => $m) {
              ...
              $student_full_name = $student_info['student_first_name']." ".$student_info['student_sur_name'];
               $msg = "Dear $student_full_name. You are absence more than 7 days. Please attend as soon as possible and submit Attendance Excuse.";
              send_sms_txt($student_info['student_mobile_phone'], $msg);

              $args = array();
              $args['student_data_id'] = $m;
              $args['phone'] = $student_info['student_mobile_phone'];
              $args['subject'] = "Alert For More Than 7 Days Absence!";
        ...
        if(isset($_GET['send_email']) && $_GET['send_email']==1) {
          ...
          if($this->session->flashdata('student_list') != "") {
            ...
            foreach ($this->session->flashdata('student_list') as $l => $m) {
              ...
              $msg = "Dear $student_full_name <br /><br /> You are absence more than 7 days. Which may effect in your attendance percentage. Please attend as soon as possible and submit Attendance Excuse to review your absence reason. <br/><br/>Thank you.";
        ...
        // var_dump($data['seven_days_absent_list']); die();
        ...
        if($action == "") {
          ...
          $this->load->view('staff/absent_seven_days');
          ...
          $this->load->view('staff/dashboard_topmenu');
          $this->load->view('staff/dashboard_sidebar');
          $this->load->view('staff/absent_seven_days_archive');
          $this->load->view('staff/dashboard_footer');   
        }  
