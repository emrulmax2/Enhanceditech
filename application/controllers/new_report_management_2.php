...
class New_report_management_2 extends CI_Controller {   
     ...
     // var_dump($dt);
      ...
      foreach($register_id_arr as $k=>$register_id){
            ...
            $hesa_course_relation_instance_id = "";
                    ...
                    //$xml .= "<QUALENT3>".!empty($all_hesa_domicile[$v['hesa_domicile_id']])."</QUALENT3>"; ///---------- ?
                    $xml .= "</EntryProfile>";
      ...
      force_download('datafile.xml', $xml);
