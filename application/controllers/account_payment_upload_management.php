...
class account_payment_upload_management extends CI_Controller {
	...
	public function index(){
        ...
        if($this->session->userdata('label')=="staff"){
                  ...
                  if(!empty($staff_access['staff_privileges']['account_payment_upload_management']) && count($staff_access['staff_privileges']['account_payment_upload_management'])>0) $priv = $data['priv'] = $staff_access['staff_privileges']['account_payment_upload_management'];                
                  else{ $priv[0] = ""; }
        }        
        /////////////////////////////////////////////////////
...
*/
	    ...
	    if(!empty($varsessioncheck_id) && $action!="search"){
	        ...
	        $data['bodytitle']       =   "Account Payment Upload";
	        $data['faicon']          =   "fa-cloud-upload";
	        $data['breadcrumbtitle'] =   "Dashboard > Account Payment Upload";             
	        ...
	        $this->load->view('staff/dashboard_topmenu');
	        $this->load->view('staff/dashboard_sidebar');
	        $this->load->view('staff/account_payment_upload_body_form.php');
	        $this->load->view('staff/other_footer');
