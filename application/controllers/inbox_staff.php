...
class Inbox_staff extends CI_Controller {   
...
public function index(){
    ...
    if(!empty($varsessioncheck_id) && ($label == "staff" || $label == "admin") && $action==Null){
		...
		$data["communication"]= $this->lcc_communication->get_all(); 
        ...
        $this->load->view('staff/inbox/inbox_view');
