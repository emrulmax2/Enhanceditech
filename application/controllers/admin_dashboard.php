...
public function index(){
    ...
    $data['message']            =   "";
    $data['bodytitle']          =   "Dashboard <small>Welcome! {$data["fullname"]} </small>";
    $data['breadcrumbtitle']    =   "Dashboard ";
    ...
    //var_dump($this->lcc_inbox->get_alert_of_staff($varsessioncheck_id)); 
...
//-------------------------------------------------------------------------------- end 1s
        ...
        $this->load->view('staff/dashboard_body');
