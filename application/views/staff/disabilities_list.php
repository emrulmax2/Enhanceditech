...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'student_others_disabilities\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>               
	                ...
	                <h4><i class="fa fa-list"></i> Disabilities List </h4>
	                <table class="dTable display">
	                    <thead>
	                        <tr>
	                            <th>Disabilities Name</th>
	                            <th>Disabilities Code</th>
	                            <th>Action</th>      
	                        </tr>
	                    </thead>
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($title_list as $k => $v){
                                    ...
                                    echo "<a href='".base_url()."index.php/others_disabilities_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
