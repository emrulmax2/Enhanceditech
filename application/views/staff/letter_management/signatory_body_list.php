...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'signatory_set\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>               
               <div class="col-lg-12">
	                ...
	                <h4><i class="fa fa-list"></i> Signatory List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($signatory_list as $k => $v){
                                    ...
                                    if( !empty($priv[2]) || $this->session->userdata('label')=="admin" )  echo"<a href='".base_url()."index.php/registration/signatory_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
