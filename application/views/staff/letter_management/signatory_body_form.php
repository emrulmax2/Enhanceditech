...
$(document).ready(function(){
	...
	<?php
		if(!empty($signatory) && is_array($signatory)){
...
?>	                
                		<a class="btn btn-md btn-primary" href="<?php echo base_url(); ?>index.php/registration/signatory_management/?action=add"><i class="fa fa-plus"></i> Add New Signatory</a>
<?php
}	                	
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/registration/signatory_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		                ...
		                <div class="col-lg-12">
		                		...
		                		<div class="row">
                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                         <h4><i class="fa fa-file-text "></i> Signatory Form </h4>
                                    </div>
		                        ...
		                        <div class="form-group">
		                            <label>Signatory Post</label>
		                            <input class="form-control" type="text" name="post" required>
		                        </div>	
		                        
<?php                       //if($ref=="edit"){       ?>		                        
		                        <div class="form-group">
		                            <div class="imgpreview"><img src="<?php if(!empty($sign_url)) echo base_url().$sign_url; ?>" class="img-responsive" alt="No file uploaded"></div>
		                        </div>		                        
<?php                       //}       ?>		                        
		                        <div class="form-group">
		                            <button  type="button" class="btn btn-md btn-warning uploadstaffdocument" data-toggle="modal" data-target="#myUploadDoc"><i class="fa fa-upload"></i> Upload File</button>
		                        </div>	
		                        
		                        <input type="hidden" name="sign_url">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
	                      <div class="msg"></div>
	                       <div class="form-group">
	                      <label class="margin-top-2">Upload Document (<i class="alert-warning"><span style="color:red;">Space not allowed inside file name</span>, File size no more than 10mb</i>) </label><br/>
