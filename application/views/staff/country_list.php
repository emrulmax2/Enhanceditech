...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'country\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/country_management/?action=add"><i class="fa fa-plus"></i> Add New Country</a>
<?php
}                			
?>                		
...
?>               
	                <h4><i class="fa fa-list"></i> Country List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($country_list as $k => $v){
	                                ...
	                                echo "<td>".$v["country_name"]."</td>";
	                                echo "<td>".$v["iso_code_2"]."</td>";
	                                echo "<td>".$v["iso_code_3"]."</td>";
                                    ...
                                    echo "<a href='".base_url()."index.php/country_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
