...
?>    	                
                		<a class="btn btn-md btn-primary" href="<?php echo base_url(); ?>index.php/others_disabilities_management/?action=add"><i class="fa fa-plus"></i> Add New Disabilities</a>
<?php
}	                	
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/others_disabilities_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		                ...
		                <div class="col-lg-12">
		                		...
		                		<div class="row">
			                		<div class="col-lg-9 col-md-9 col-sm-9">
			                			 <h4><i class="fa fa-file-text "></i> Disabilities Form </h4>
			                		</div>
		                        ...
		                        <div class="form-group">
		                            <label>Disabilities Name</label>
		                            <input class="form-control" type="text" name="name" required>
		                        </div>
		                        <div class="form-group">
		                            <label>Disabilities Code</label>
		                            <input required class="form-control" type="text" name="code" maxlength="5" placeholder="Maximum 5 characters">
		                        </div>
