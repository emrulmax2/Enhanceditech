...
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/marital_status_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
                ...
                <div class="row">
                    ...
                    <form role="form" method="post">
		                ...
		                <h4><i class="fa fa-file-text "></i> Marital status Form </h4>
