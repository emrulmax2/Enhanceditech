...
$(function() {
    ...
    $('.class-plan-list-body').find('.class-plan-id').on("click", function() {
        var i =0; 
        //alert("ok");
        $.each($('.class-plan-list-body').find('.class-plan-id'),function(){
...
function studentListToSendSmsEmail(){
    ...
    $('.btn-assign-student').click(function(e){
        ...
        // alert(start_end_date); return false;
...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                         <a href="<?php echo base_url() ?>absent_by_seven_days" class="btn btn-warning"><i class="fa fa-arrow-circle-left"></i> Back To List</a>
                    </div>
                    <div class="col-lg-6 text-right show-sms-email">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table absent_list_dashboard">
                                    <tr>
                                        <th width="10%"><div class='checkbox checkbox-primary'><input id='checkbox99999999999' type='checkbox' class='form-control select-all-class-plan-list'><label for='checkbox99999999999'>Student ID</label></div></th>
                                        <th width="20%">Date</th>
                                        <th width="15%">Name</th>
                                    ...
                                    // echo "</pre>";
                                    $absent_sms_email = $this->attendance_notify->get_sms_email_by_student_data_id_start_date_end_date_absence_type($student_id,$lower,$higher,$absence_type,1 );
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td width="10%" class="parent_of_class_plan"><div class='checkbox checkbox-primary'><input name='class_id[]' id='checkbox_<?php echo $student_id ?>' type='checkbox' class='form-control class-plan-id' value='<?php echo $student_id ?>'><label for='checkbox_<?php echo $student_id ?>'><?php echo $student_id ?></label></div></div></td>

                                            <td width="20%" class="lowest_highest_date"><?php echo $lower ." to ".$higher ?></td>
                                            ...
                                            <td width="10%" style="text-transform: uppercase;"><?php echo $this->register->get_registration_no_by_ID($k); ?></td>
                                            <td width="20%"><?php echo (!empty($student_info['student_course'])) ? $this->course->get_name( $student_info['student_course'] ) : "" ; ?></td>
                                            <td width="25%"><?php echo  $this->coursemodule->get_name_by_id( $course_module) ; ?></td>
