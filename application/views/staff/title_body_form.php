...
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/title_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		                ...
		                <div class="col-lg-12">
			                	...
			                	<div class="row">
			                		<div class="col-lg-9 col-md-9 col-sm-9">
			                			 <h4><i class="fa fa-file-text "></i> Title Form </h4>
			                		</div>
