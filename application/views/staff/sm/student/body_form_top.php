...
?> 
       ...
       //var_dump($user_data);
        if($user_data && is_array($user_data)){
            foreach($user_data as $k=>$v){
                ...
                if($k!="student_course" && $k!="kin_address" && $k!="student_semister" && $k!="student_marital_status"  && $k!="disabilities_allowance" && $k!="student_admission_status_hesa_reason_id")   echo "$('input[name=$k]').val('".tinymce_decode($v)."');";
            ...
            foreach($user_data as $k=>$v){
               ...
               <?php
                ...
                if($k=="campus_info_id" && $v==0){
                    echo "$('select[name=$k]').val('');";    
                }                 
        ...
        if(!empty($hesa_student_information_data)){
            ...
            if(!empty($hesa_student_information_data['hesa_notact_id']) && $hesa_student_information_data['hesa_notact_id']>0) echo "$('select[name=hesa_notact_id]').val('".$hesa_student_information_data['hesa_notact_id']."');";           
            ...
            if(!empty($hesa_student_information_data['hesa_yearstu']) ) echo "$('input[name=hesa_yearstu]').val('".$hesa_student_information_data['hesa_yearstu']."');";            
            if(!empty($hesa_student_information_data['hesa_qual_id']) ) echo "$('select[name=hesa_qual_id]').val('".$hesa_student_information_data['hesa_qual_id']."');";
             if(!empty($hesa_student_information_data['hesa_genderid_id']) ) echo "$('select[name=hesa_genderid_id]').val('".$hesa_student_information_data['hesa_genderid_id']."');";            
        }        
    ...
    $('.student-account-access-confirm-btn').click(function(){
            ...
            $.ajax({
               type: "POST",
               data: {student_data_id:'<?php echo $user_data['student_data_id']; ?>', action: "changeStudentAccess" },
               url: url,
    ...
    //alert($("select[name=student_type]").val()); 
    
    
    /*$("form#registerinfo button.register-personal-info-submit").bind("click",function(){
        
       alert($("form#registerglobalinfo select[name=student_type]").val()); 
			     ...
			     <div class="col-sm-12 no-pad">		                		            
		                ...
		                <div class="col-lg-12">
					                ...
					                <div class="text-right">
	                                     <?php if(!empty($priv[14]) || $this->session->userdata('label')=="admin"){ ?><button type="button" name="changestatusbutton" class="btn btn-md btn-warning changestatusbutton"><i class="fa fa-check"></i> Change status</button><?php } ?>
                                        <?php if(!empty($priv[16]) || $this->session->userdata('label')=="admin"){ ?>
                        		...
                        		<div class="col-sm-9 no-pad-left">
	                                 <div class="form-group clearfix">
                               			<h4><i class="fa fa-eye "></i> Student Details </h4>
                               			<p class="divider"></p>
                             		 </div>                                 
                             		 <div class="form-group clearfix">
		                                <div class="col-sm-3">
		                                ...
		                                <div class="col-sm-3 ">
                                    <?php if(!empty($user_data['registration_no'])) {?>
		                                        <?php echo strtoupper( $user_data['registration_no'] ); ?>
                                    <?php } else { ?>
                                      Not yet registered.
                                    <?php } ?>
		                                </div>
                                     ...
                                     <!--Start admission status information -->
                                         ...
                                         <div class="form-group clearfix">
                                            ...
                                            <div class="col-sm-3">
                                            <?php if(!empty($student_information->status )) {?>
                                                    <p><b><?php echo $this->status->get_name_by_id( $student_information->status ); ?></b></p>
                                            <?php } ?>
                                            </div>
                                            <div class="col-sm-3">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control" name="student_id_card_no" value="<?php if(!empty($student_information->student_id_card_no)) echo $student_information->student_id_card_no;  ?>" />
                                            </div>                                            
                                         </div>
                                ...
                                <div class="divider"></div>
                                  <div class="form-group clearfix">
                                    ...
                                    <div class="col-sm-9 ">
                                      <?php echo $this->semister->get_name($user_data['student_semister']); ?>
                                    </div>
...
<?php
                                            $i = 0;
                                            if(!empty($hesa_instance)) {
                                            foreach($hesa_instance as $k=>$v){
                                                
                                                ?>
                                                <div class="form-group clearfix">
                                                  <input type="hidden" name="hesa_stuload_student_info_id[]" value="<?php echo $v['id'] ?>">
                                                  <div class="col-sm-6">
                                                          <label>Year of the Course/Instance : <?php echo $v['year_of_the_course'] ?> <br> <?php echo "[ ".date("d-m-Y",strtotime($v['instance_start_date']))." to ".date("d-m-Y",strtotime($v['instance_end_date']))." ]";  ?> </label>
                                                  </div>
                                                  <div class="col-sm-6 ">
                                                    <div class="col-sm-6">
                                                      <label>Stuload :</label>
                                                    ...
                                                    <div class="col-sm-6 no-pad-right">
                                                      <input type="text" class="form-control" name="student_load_<?php echo $i; ?>" value="<?php echo $v['student_load'] ?>" placeholder="Start Date" />
                                                    </div>
   ...
   ?>   
                                      ...
                                      <div class="form-group clearfix">
                                        ...
                                        <div class="col-sm-3 ">
                                                <?php echo !empty($user_data['section']) ? $user_data['section'] : ""; ?>
                                        </div>
                                        <div class="col-sm-3">
                                                <label>App. Ref. No: </label>
                                        </div>
                                        <div class="col-sm-3 ">
                                                <?php echo !empty($user_data['student_application_reference_no']) ? $user_data['student_application_reference_no'] : ""; ?>                                        
                                        </div>    
                                      </div>                                                                  	                              	                              	                     	
                             		 <div class="divider"></div>
                             		 <div class="form-group clearfix">
...
?>
                                 ...
                                 <div class="form-group clearfix">
                                    ...
                                    <div class="col-sm-3">
                                            <label>Not in active study : </label>
                                    </div>
                                    <div class="col-sm-3 ">
                                                <select name="hesa_notact_id"  class="form-control" required>
                                                    <option value="">Please Select</option>
<?php
                                                    if(!empty($hesa_notact_list)){
...
?>
                                 ...
                                 <div class="divider"></div>
                             		 <div class="form-group clearfix">
		                                ...
		                                <div class="col-sm-3 ">
	                                            <select name="student_type"  class="form-control std_type_check" required>
		                                            <option value="">Please Select</option>
...
?>                                                    
                                    ...
                                    <div class="form-group clearfix">
                                        ...
                                        <div class="col-sm-3">
                                                ...
                                                <input type="text" class="form-control" name="hesa_yearstu" value="" />                                               
                                        </div>
                                        <div class="col-sm-3">
                                                <label>Campus Location: </label>
                                        </div>
                                        <div class="col-sm-3">
                                                <select name="campus_info_id"  class="form-control" required>
                                                    <option value="">Please Select</option>

<?php
                                                    if(!empty($campus_info_list)){
                                                       foreach($campus_info_list as $k=>$v){
                                                            echo'<option value="'.$v['id'].'">'.$v['name'].'</option>';    
                                                       } 
                                                    }                                                          
?>                                                    
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="col-sm-12">
                                                <label>Qualification Achievement After Completion: </label>

                                                
                                                <select name="hesa_qual_id"  class="form-control" required>
                                                    <option value="">Please Select</option>

<?php
                                                    if(!empty($hesa_qual_list)){
                                                       foreach($hesa_qual_list as $k=>$v){
                                                            echo'<option value="'.$v['id'].'">'.$v['name'].'</option>';    
                                                       } 
                                                    }                                                          
?>                                                    
...
<!-- Newly Added -->                                     
                            ...
                            <div class="col-sm-3 no-pad">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <div class="panel-body nsidep-body">  
                ...
                <div class="modal fade" id="myApplicationStatus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="msg"></div>
                       ...
                       <label for="formstatus "> Change aplication current status : <img class="loading" src="<?php echo base_url(); ?>/images/loading.png" alt=""></label>
                        <select id="changestatus" class="formstatus form-control" >
                            ...
                            <option <?php echo ( !empty($student_information) && ($student_information->status == $v['id'])) ? "selected" : "" ?> value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                            <?php } ?>
                        </select>
                        </div>
                        <div class="form-group">
                          <label for="hesa_reason">Change Status Reason</label>
                          <input class="form-control" type="text" name="status_change_reason" id="" maxlength="100" value="<?php echo ( !empty($student_information) && ($student_information->status_change_reason > "")) ? $student_information->status_change_reason : "" ?>">
                        </div>

                        <div class="form-group">
                          <label for="hesa_reason">Hesa Reason</label>
                          <select name="student_status_hesa_reason_id" class="form-control" required>
                            <option value="">Please Select</option>
                            <?php if(!empty($hesa_rsnend)) {?>
                            <?php foreach($hesa_rsnend as $k=>$v) {?>
                              <option <?php echo ( !empty($student_information) && ($student_information->student_status_hesa_reason_id == $v['id'])) ? "selected" : "" ?> value="<?php echo $v['id'] ?>"><?php echo $v['name'] ?></option>
                            <?php } ?>
                            <?php } ?>
                      ...
                      <div class="modal-footer">
                        <button type="button" name="change_student_status" class="btn btn-success" id="changebuttonstate" student_data_id="<?php echo $user_data['id'];  ?>" ><i class="fa fa-check"></i> Change</button>
                        <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fa fa-remove"></i> Cancel</button>
                      </div>
                    </div><!-- /.modal-content -->
                  </div><!-- /.modal-dialog -->
