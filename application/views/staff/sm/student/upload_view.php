            ...
            <?php if(!empty($priv[19]) || $this->session->userdata('label')=="admin"){ ?>
              <button class="btn btn-md btn-warning uploadstaffdocument" data-toggle="modal" data-target="#myUploadDoc"><i class="fa fa-plus"></i> Add Document</button>
            <?php } ?>
            </div>
