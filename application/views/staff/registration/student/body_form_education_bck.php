...
if($_POST) {
    ...
    if($has_other_qualification == "yes")
    {
        ...
        $qualification_array =   $this->input->post("student_other_qualification");
		                ...
		                <div class="col-lg-12">
			                <div class="row">
				                ...
				                <div class="col-sm-12 text-right">
                         			...
                         			<?php //if(!empty($staff_privileges_student_admission['std_ad_edit_app']) || $this->session->userdata('label')=="admin"){ ?><button type="submit" class="btn btn-sm btn-success "><i class="fa fa-save"></i> Update </button><?php //} ?>
					             </div>	   
				             </div> 
