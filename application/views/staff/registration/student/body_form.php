			                ...
			                <div class="row">
				                ...
				                <div class="col-sm-12 text-right">
				                	<img src="<?php echo base_url(); ?>images/loading.gif" class="loading">
                         			...
                         			<?php if((!empty($priv[9]) || $this->session->userdata('label')=="admin")){ ?><button type="button" class="btn btn-sm btn-success register-personal-info-submit"><i class="fa fa-save"></i> Update </button><?php } ?>
					             </div>	   
				             </div> 
                             <div class="msg"></div>
