...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'currency\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>               		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/currency_management/?action=add"><i class="fa fa-plus"></i> Add New Currency</a>
<?php
}                			
?>                		
...
?>                
	                ...
	                <h4><i class="fa fa-list"></i> Currency List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($currency_list as $k => $v){
	                                ...
	                                echo "<td>".$v["currency_name"]."</td>";
	                                echo "<td>".$v["currency_code"]."</td>";
	                                echo "<td>".$v["currency_symbol"]."</td>";
	                                ?>
	                                <td>
	                                	<?php if($v["symbol_position"]==1) {?>
										Left
	                                	<?php } elseif($v["symbol_position"]==0) {?>
										Right
	                                	<?php } ?>
	                                </td>
	                                <?php
	                                ...
	                                echo "<a href='".base_url()."index.php/currency_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
