...
$(document).ready(function(){
	...
	$('tbody.class-list td .class-plan-id').click(function(){
		...
		if(i==1){
			...
			$('.vew-feed-attendance').append("<?php if(!empty($priv[2]) || $this->session->userdata('label')=="admin"){ ?><a class='btn btn-md btn-primary btn-assign-student' href='?action=send_sms&class_plan_id="+id+"'><i class=\"fa fa-mobile\"></i> Send SMS</a><?php } ?><?php if(!empty($priv[3]) || $this->session->userdata('label')=="admin"){ ?><a class='btn btn-md btn-danger btn-assign-student' href='<?php echo base_url(); ?>index.php/print_student_list/?class_plan_id="+id+"'><i class=\"fa fa-fw fa-print\"></i> Print student</a><?php } ?><?php if(!empty($priv[4]) || $this->session->userdata('label')=="admin"){ ?><a class='btn btn-md btn-success btn-assign-student' href='?action=view_student_list&class_plan_id="+id+"'><i class=\"fa fa-eye\"></i> Feed attendance</a><?php } ?>");
...
?>                		
                ...
                <div class="row">
                    ...
                    <form role="form" method="post" action="<?php echo base_url(); ?>index.php/print_class_routine_management/?action=search">
								...
								<div class="panel-heading">
				                	<div class="row">
				                		<div class="col-lg-7 col-md-7 col-sm-7">
				                			 <h4><i class="fa fa-calendar"></i> Class Routine </h4>
				                		</div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="text-left">
						<?php if(!empty($priv[1]) || $this->session->userdata('label')=="admin") echo $print_btn; ?>
					</div>
				</div>
				<div class="col-lg-6">
            ...
            <div class="row"><?php if(!empty($priv[0]) || $this->session->userdata('label')=="admin"){ if(!empty($result)) echo $result; } ?></div>
