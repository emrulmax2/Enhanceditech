...
function recallRemove(){
               ...
               <?php the_page_heading($bodytitle,$breadcrumbtitle,$faicon); ?>     
                    ...
                    <form class="search_student_form" role="form" method="post" action="<?php echo base_url(); ?>index.php/student_admission_management/?action=search">
							...
							<div class="panel-heading">
                              <div class="row">
                                ...
                                <button type="submit" class="btn btn-md btn-success"><i class="fa fa-search"></i> Search</button>
                                       <a href="<?php echo base_url(); ?>index.php/student_admission_management/?action=all" class="btn btn-md btn-primary"><i class="fa fa-users"></i> All Student</a>
