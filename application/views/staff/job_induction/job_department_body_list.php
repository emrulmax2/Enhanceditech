...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'job_department\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                
	                ...
	                <h4><i class="fa fa-list"></i> Department List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($department_list as $k => $v){
	                                ...
	                                echo "<a href='".base_url()."index.php/job_induction/job_department_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
