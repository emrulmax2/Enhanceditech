...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'job_type\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                 		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/job_induction/job_type_management/?action=add"><i class="fa fa-plus"></i> Add New Job Type</a>
<?php
}                			
?>                		
...
?>                
	                ...
	                <h4><i class="fa fa-list"></i> Job Type List </h4>
	                        	...
	                        	if(!empty($job_type)) {
		                            ...
		                            foreach($job_type as $k => $v){
		                                ...
		                                if($v['id'] != 1) {
			                                ...
			                                echo "<a href='".base_url()."index.php/job_induction/job_type_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
