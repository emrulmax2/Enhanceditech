...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'modules\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>/index.php/module_management/?action=add"><i class="fa fa-plus"></i> Add Module</a>
<?php
//}                			
?>                		
...
<!--                    <form role="form">
               ...
               <div class="col-lg-12">
	                ...
	                <h4><i class="fa fa-list"></i> Modules List </h4>
	                        ...
	                        <?php
	                            ...
	                            foreach($module_list as $k => $v){
	                               ...
	                               // if(empty($staff_privileges_course_management['course_mng_edit']) && $this->session->userdata('label')!="admin")
	                                //echo"<td></td>";
	                               // else
	                                echo "<td><a href='".base_url()."/index.php/module_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a><a href='javascript:void(0);' class='btn btn-sm btn-danger remove-btn' id='".$v["id"]."'><i class='fa fa-times'></i></a></td>";
	                                echo "</tr>";
