...
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/country_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		           		...
		           		<div class="col-lg-12">
			                	...
			                	<div class="row">
			                		<div class="col-lg-9 col-md-9 col-sm-9">
			                			 <h4><i class="fa fa-file-text "></i> Country Form </h4>
			                		</div>
		                        ...
		                        <div class="form-group">
		                            ...
		                            <input class="form-control" type="text" name="iso_code_2" maxlength="2">
		                        </div>
		                        <div class="form-group">
		                            <label>ISO Code 3</label>
		                            <input class="form-control" type="text" name="iso_code_3" maxlength="2">
		                        </div>	
