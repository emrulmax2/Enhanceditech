...
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                         <a href="<?php echo base_url() ?>absent_by_ten_days" class="btn btn-warning"><i class="fa fa-arrow-circle-left"></i> Back To List</a>
                    </div>
