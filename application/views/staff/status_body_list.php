...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'status\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>               		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/status_management/?action=add"><i class="fa fa-plus"></i> Add New Status</a>
<?php
}                			
?>                		
...
?>                
	                <h4><i class="fa fa-list"></i> Status List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($title_list as $k => $v){
	                                ...
	                                echo "<a href='".base_url()."index.php/status_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
