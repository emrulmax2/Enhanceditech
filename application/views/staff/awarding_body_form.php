...
$(document).ready(function(){
	...
	<?php
		if(!empty($awarding_body) && is_array($awarding_body)){
			foreach($awarding_body as $k=>$v){
...
?>	                
                		<a class="btn btn-md btn-primary" href="<?php echo base_url(); ?>index.php/awarding_body_management/?action=add"><i class="fa fa-plus"></i> Add New Awarding Body</a>
<?php
}	                	
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/awarding_body_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		                ...
		                <div class="col-lg-12">
			                	...
			                	<div class="row">
			                		<div class="col-lg-9 col-md-9 col-sm-9">
			                			 <h4><i class="fa fa-file-text "></i> Awarding Body Form </h4>
			                		</div>
	                        ...
	                        <div class="form-group">
	                            <label>Awarding body name</label>
