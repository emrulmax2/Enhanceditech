...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'student_title\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/title_management/?action=add"><i class="fa fa-plus"></i> Add New Title</a>
<?php
}                			
?>                		
...
?>                
	                <h4><i class="fa fa-list"></i> Title List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($title_list as $k => $v){
                                    ...
                                    echo "<a href='".base_url()."index.php/title_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
