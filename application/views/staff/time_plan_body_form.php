...
$(document).ready(function(){
	...
	<?php
		if(!empty($time_plan) && is_array($time_plan)){
			foreach($time_plan as $k=>$v){
...
?>                		
                		<a class="btn btn-md btn-info" href="<?php echo base_url(); ?>index.php/time_plan_management/?action=list"><i class="fa fa-list"></i> Back to List</a>
	                </div>
		                ...
		                <div class="col-lg-12">
			                	...
			                	<div class="row">
			                		<div class="col-lg-9 col-md-9 col-sm-9">
			                			 <h4><i class="fa fa-file-text "></i> Time Plan Form </h4>
			                		</div>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <input class="form-control time" type="text" name="start_time" required> 
	                        </div>
	                        <div class="form-group">
	                            <label>End Time</label>
	                            <input class="form-control time" type="text" name="end_time" required>
	                        </div>	                        
