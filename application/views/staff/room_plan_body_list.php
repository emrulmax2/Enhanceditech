...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'room_plan\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>               	
               ...
               <div class="col-lg-12">
	                ...
	                <h4><i class="fa fa-list"></i> Room Plan List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($room_plan_list as $k => $v){
	                                ...
	                                echo "<td>".$v["name"]."</td>";
	                                echo "<td>".$v["capacity"]."</td>";
	                                //if(empty($staff_privileges_course_management['course_mng_edit']) && $this->session->userdata('label')!="admin")
	                                //echo"<td></td>";
	                                //else
	                                echo "<td>";
                                    if(!empty($priv[2]) || $this->session->userdata('label')=="admin") echo"<a href='".base_url()."index.php/room_plan_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
