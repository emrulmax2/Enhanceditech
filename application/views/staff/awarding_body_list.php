...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'awarding_body\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                
	                ...
	                <h4><i class="fa fa-list"></i> Awarding Body List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($awarding_body_list as $k => $v){
                                  ...
                                  echo "<a href='".base_url()."index.php/awarding_body_management/?action=edit&id=".$v["ID"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
