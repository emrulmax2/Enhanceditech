...
function recallRemove(){
    $('.remove-btn').click(function(){
        ...
        $('#myModal').find('.confirm-btn').attr('onclick','RemoveFromList(\''+id+'\',\'student_others_ethnicity\')');
        $('#myModal').css({'top':'30%'});
        $('#myModal').modal('hide');
...
?>                		
                		<a class="btn btn-md btn-primary"  href="<?php echo base_url(); ?>index.php/others_ethnicity_management/?action=add"><i class="fa fa-plus"></i> Add New Ethnicity</a>
<?php
}                			
?>                		
...
?>                
	                <h4><i class="fa fa-list"></i> Ethnicity List </h4>
	                    ...
	                    <tbody>
	                        <?php
	                            ...
	                            foreach($ethnicity_list as $k => $v){
                                    ...
                                    echo "<a href='".base_url()."index.php/others_ethnicity_management/?action=edit&id=".$v["id"]."' class='btn btn-sm btn-success margin-right-5'><i class='fa fa-pencil-square-o'></i></a>";
