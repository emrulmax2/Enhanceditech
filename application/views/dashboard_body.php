                ...
                <div class="row">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                     <a href="<?php echo base_url(); ?>index.php/purchase_management">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                <a href="<?php echo base_url(); ?>index.php/production_management"> <span class="pull-left">View Details</span><span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span></a>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-yellow">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <a href="<?php echo base_url(); ?>index.php/sale_management"><span class="pull-left">View Details</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <a href="<?php echo base_url(); ?>index.php/accounts_journal"><span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
