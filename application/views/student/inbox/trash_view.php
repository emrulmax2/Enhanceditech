            ...
            <?php echo $message; ?>  
               ...
               <div class="col-lg-12">
                    <h4><i class="fa fa-trash"></i> Trash </h4> 
						  ...
						  <?php if($inbox_row["notification_type"]== "communication" && $inbox_row["notification_from"]=="staff") { ?>
                          ...
                          <?php } else if($inbox_row["notification_type"]== "exam" && $inbox_row["notification_from"]=="staff" ) { ?>
