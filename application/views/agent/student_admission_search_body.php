...
$(".search-student-list tbody tr").click(function(){
        ...
        var id = $(this).attr("id");
        if(id>""){
        location.href = getURL()+'/index.php/agent_dashboard/?action=singleview&do=application&id='+id;
		 }	
});	
...
function recallRemove(){
               ...
               <?php the_page_heading($bodytitle,$breadcrumbtitle,$faicon); ?>     
                    ...
                    <form class="search_student_form" role="form" method="post" action="<?php echo base_url(); ?>index.php/agent_dashboard/?action=search">
							...
							<div class="panel-heading">
                              <div class="row">
                                ...
                                <button type="submit" class="btn btn-md btn-success"><i class="fa fa-search"></i> Search</button>
                                       <a href="<?php echo base_url(); ?>index.php/agent_dashboard/?action=all" class="btn btn-md btn-primary"><i class="fa fa-users"></i> All Student</a>
...
?>												  
				                        ...
				                        <div class="form-group col-lg-3 col-xs-12   no-pad-left">
				                            <label>Status</label>
											<select class="form-control" name="student_admission_status">
											  <option value="">Please Select</option>
<?php
...
?>											  
				                        ...
				                        <div class="form-group col-lg-3 col-xs-12  no-pad-left no-pad-right">
				                            <label>Agent: <?php echo ucfirst($this->session->userdata('fullname'));?></label>
