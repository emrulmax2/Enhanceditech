...
function print_form(cls){
    ...
    newwin.document.write('.text-mid{ font-size: 150%; }\n');
    newwin.document.write('.text-large{ font-size: 200%; }\n');
    ...
    newwin.document.write('.blocked_header{ background-color: \'Gray\'; padding: 8px; font-weight:bold; font-size: 130%; }\n');
    newwin.document.write('.field_header{ font-size: 110%; padding:8px; font-weight:bold; }\n');
    newwin.document.write('.field_text{ font-size: 110%; text-transform: capitalize; padding:8px; }\n');
    newwin.document.write('.field_text{ font-size: 110%; text-transform: capitalize; padding:8px; }\n');
	...
	width:50%;
                ...
                <div class="row div_print_table">
					...
					<table class="print_table" border="0">
						...
						<tr>
						     <td><img src="<?php echo $settings["logo_url"]; ?>" class="com_logo">&nbsp;<font size="5%"><?php echo $settings["company_name"]; ?></font></td>
						...
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     ...
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php echo $user_data['student_gender']; ?></td>
						</tr>
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     <td class="field_header" style="border-top: 1px solid #ddd;">Nationality:</td>
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php echo $user_data['student_nationality']; ?></td>
						</tr>
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     <td class="field_header" style="border-top: 1px solid #ddd;">Country Of Birth:</td>
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php echo $user_data['student_country_of_birth']; ?></td>
						</tr>
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     <td class="field_header" style="border-top: 1px solid #ddd;">Marital Status:</td>
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php echo $user_data['student_marital_status']; ?></td>
						</tr>																																				
						<tr>
						...
						<tr>
						     ...
						     <td class="field_text"><?php if(preg_match("/^[a-zA-Z ]*$/",$user_data['student_semister'])) echo $user_data['student_semister']; else echo $this->semister->get_name($user_data['student_semister']); ?></td>
						</tr>						
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     <td class="field_header" style="border-top: 1px solid #ddd;">Which course do you propose to take?</td>
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php if(preg_match("/^[a-zA-Z ]*$/",$user_data['student_course'])) echo $user_data['student_course']; else echo $this->course->get_name($user_data['student_course']); ?></td>
						</tr>						
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						...
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
						     ...
						     <td class="field_text" style="border-top: 1px solid #ddd;">&nbsp;<?php echo $user_data['student_others_ethnicity']; ?></td>
						</tr>												
						<tr class="border-top" style="border-top-style: solid; border-top-color: #dddddd; border-top-width: thin;">
